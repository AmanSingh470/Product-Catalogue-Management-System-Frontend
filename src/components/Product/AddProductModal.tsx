...
export default function AddProductModal() {
    ...
    return (
        <div id="add-product-modal" className="flex fixed inset-0 z-9999 bg-black/50 items-center justify-center">
            ...
            <div
                ...
                <div id="add-product-modal-content" className="overflow-y-auto p-4 flex-1">
                    <AddProductForm />
                </div>
