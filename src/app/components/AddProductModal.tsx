            ...
            <form id="add-product-form" className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select className="w-full mt-1 border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-600">
                ...
                <div>
                    ...
                    <div
                        className="border border-gray-300 rounded-t-md px-3 py-2 flex gap-3 text-sm text-gray-600 bg-gray-50">
                    ...
                    <textarea
                        className="w-full border border-t-0 border-gray-300 rounded-b-md px-3 py-2 h-40 focus:outline-none focus:ring-2 focus:ring-red-500"></textarea>
                </div>
